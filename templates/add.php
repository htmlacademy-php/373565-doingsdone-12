    ...
    <form class="form" action="add.php" method="post" autocomplete="off" enctype="multipart/form-data">
        <div class="form__row">
            ...
            <input class="form__input <?= getClassError($errors, 'name'); ?>" type="text" name="name" id="name"
                   value="<?= trim(getPostVal('name')); ?>" placeholder="Введите название">
        ...
        <div class="form__row">
            ...
            <select class="form__input form__input--select <?= getClassError($errors, 'project'); ?>" name="project"
                    id="project">
                <?php if (!count($projects)): ?>
                    <option value=""></option>
                <?php endif; ?>
                <?php foreach ($projects as $project): ?>
                    <option value="<?= getValue($project, 'id'); ?>"<?= getSelected('project',
                        $project['id']) ?>><?= htmlspecialchars(getValue($project, 'name')); ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <div class="form__row">
            ...
            <input class="form__input form__input--date <?= getClassError($errors, 'date'); ?>" type="text" name="date"
                   id="date" value="<?= getPostVal('date'); ?>" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
